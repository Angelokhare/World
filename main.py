...
@app.route("/")
def home():
    dope=datetime.datetime.now().strftime("%Y")  
    return render_template("index.html", bot=dope)
...
def projects():
   ...
   #  kl=len(df)  
    print(df) 
    return render_template("projects.html", bot=dope, lis=df)

@app.route("/about")
def about():
    dope=datetime.datetime.now().strftime("%Y") 
    return render_template("about.html", bot=dope)

@app.route("/cv")
def cv():
    dope=datetime.datetime.now().strftime("%Y") 
    return render_template("cv.pdf", bot=dope)        
